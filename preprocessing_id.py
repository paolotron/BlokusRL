...
def preprocess_id():
    wb = xl.load_workbook('Blokus Pieces.xlsx', data_only=True) # workbook
    ...
    with open('pieces_data.pickle', 'wb') as handle:
        pk.dump([position_square, count_pos_squares, position_attach, count_pos_attach, position_forbid, count_pos_forbid], handle)
    pass
